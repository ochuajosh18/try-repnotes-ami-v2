import {
  DynamicUpcomingCallsInputInterface,
...
interface UpcomingCallsReportProps {
  data: Array<DynamicUpcomingCallsInputInterface<DynamicUpcomingCallsType>>;
}
...
const UpcomingCallsReport = (props: UpcomingCallsReportProps) => {
  return (
    <Box marginTop='8px'>
      <RepnotesTable
...
export default UpcomingCallsReport;
