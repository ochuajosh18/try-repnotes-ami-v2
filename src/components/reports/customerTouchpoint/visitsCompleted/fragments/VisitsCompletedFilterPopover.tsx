...
const ProductPerformanceFilterPopover = ({ children, onExportClick }: { children: ReactNode | Array<ReactNode>; onExportClick: () => void; }) => {
    ...
    return (
        <Box height="100%" width="100%" display="flex" alignItems="flex-end" boxSizing="border-box" padding="6px 0"> 
            ...
            >
                <Box width="300px" padding="20px" boxSizing="border-box" className="picker-container">
                    {children}
                </Box>
            </Popover>
        </Box>
...
export default ProductPerformanceFilterPopover;