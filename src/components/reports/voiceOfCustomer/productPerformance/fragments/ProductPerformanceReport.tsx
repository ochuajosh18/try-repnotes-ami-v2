import {
  DynamicProductPerformanceInputInterface,
  DynamicProductPerformanceType,
} from "../../../../../store/report/voiceOfCustomer/productPerformance/types";
...
interface ProductPerformanceReportProps {
  data: Array<DynamicProductPerformanceInputInterface<DynamicProductPerformanceType>>;
}
...
const ProductPerformanceReport = (props: ProductPerformanceReportProps) => {
  return (
    <Box marginTop='8px'>
      <RepnotesTable
