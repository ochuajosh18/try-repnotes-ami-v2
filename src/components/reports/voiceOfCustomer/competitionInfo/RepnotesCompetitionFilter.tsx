...
interface RepnotesProfilePopoverProps {
    ...
    industryId: string;
    competitionFilter: (field: string, value: string) => void;
}

export const RepnotesCompetitionFilter = (props: RepnotesProfilePopoverProps) => {
                            ...
                            <Grid item xs={10} style={{padding:"0 5px"}}>
                                <RepnotesInput
                                    ...
                                    onAutocompleteChange={(e, o) => {
                                        props.competitionFilter('industryId', o ? o.value : '');
                                    }}
                                ...
                                <RepnotesInput
                                    ...
                                    onAutocompleteChange={(e, o) => {
                                        props.competitionFilter('customerTypeId', o ? o.value : '');
                                    }}
                                    disableAutocompletePopover={true}
                                />
                                <RepnotesInput
                                    ...
                                    onAutocompleteChange={(e, o) => {
                                        props.competitionFilter('customerId', o ? o.value : '');
                                    }}
                                    disableAutocompletePopover={true}
                                />
                            </Grid>
