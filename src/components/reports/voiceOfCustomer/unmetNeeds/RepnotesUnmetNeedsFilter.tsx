...
interface RepnotesProfilePopoverProps {
    ...
    unmetNeedsFilter: (field: string, value: string) => void;
    customerTypeId: string;
    industryId: string;
    modelId: string;
}

export const RepnotesUnmetNeedsFilter = (props: RepnotesProfilePopoverProps) => {
                            ...
                            <Grid item xs={10} style={{padding:"0 5px"}}>
                                <RepnotesInput
                                    ...
                                    onAutocompleteChange={(e, o) => {
                                        props.unmetNeedsFilter('industryId', o ? o.value : '');
                                    }}
                                ...
                                <RepnotesInput
                                    ...
                                    onAutocompleteChange={(e, o) => {
                                        props.unmetNeedsFilter('customerTypeId', o ? o.value : '');
                                    }}
                                    disableAutocompletePopover={true}
                                />
                                 <RepnotesInput
                                    ...
                                    onAutocompleteChange={(e, o) => {
                                        props.unmetNeedsFilter('modelId', o ? o.value : '');
                                    }}
                                    disableAutocompletePopover={true}
                                />
                            </Grid>
