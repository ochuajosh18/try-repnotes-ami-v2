...
interface RepnotesFeatureImportProps {
    open: boolean;
    importData: Array<StandardMachineFeature | OptionalMachineFeature>;
    onClear: () => void;
    disabled?: boolean;
    loading?: boolean;
    onSave: () => void;
...
const IMPORT_COLUMN = [
    ...
    { field: 'subFeatureName', title: 'Sub-Feature', cellStyle, headerStyle},
];
...
const RepnotesFeatureImport = (props: RepnotesFeatureImportProps) => {
                                ...
                                <Grid item xs={12} style={{ paddingTop: 20, paddingBottom: 20, textAlign: 'center' }}>
                                    { loading ?
                                        ...
                                        <RepnotesImportTable 
                                            ...
                                            columns={props.type === 'standard' ? IMPORT_COLUMN : [
                                                ...IMPORT_COLUMN, 
                                                { field: 'subFeaturePrice', title: 'Sub-Feature Price', cellStyle, headerStyle },
                                            ]}
                                        />
                                    }
                                </Grid>
...
export default RepnotesFeatureImport;